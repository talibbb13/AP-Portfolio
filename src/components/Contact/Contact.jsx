...
function Contact() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0F0F0F] py-32 bg-[url('https://i.imgur.com/Mt8gafZ.png')] bg-repeat-y bg-cover before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-black before:opacity-90 before:z-0">

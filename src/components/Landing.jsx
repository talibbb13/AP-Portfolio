...
function Landing() {
  ...
  return (
    <div
      data-scroll
      data-scroll-speed="-.3"
      className="w-full min-h-screen flex flex-col  px-14"
    >
      <div className="mainHeadings text-[10rem] font-black -mt-16 pt-40">
        ...
        <CreateStringBand/>
      <div className="absolute bottom-7 right-0 h-[10vh] w-full border-zinc-800 px-14 py-5">
